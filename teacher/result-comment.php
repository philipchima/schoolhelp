   ...
   // Getting the Department ID
    ...
    $records=$SHteacher->allposi4sort($positiontblname, $levelid, $optionid, $sessionid, $semesterid, 'average', 'DESC');
            ...
            foreach($records as $fieldrecord){
             ...
             $state= $tableUpdate->update_fourfields($positiontblname, 'positionid', trim($fieldrecord['positionid']), 'hodcommentid',  $staffcommentid, 'comment',  $comment, 'instructorid', $staffid, 'instructorudate', $udate);
