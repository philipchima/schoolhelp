	...
	if ($page == 2)
		{
			...
			$coursematerialsvideo=$_FILES["coursematerialsvideo"]["name"];
           if($coursematerialsvideo!=""){
              $target_dir = "../schoolhelp/uploads/coursematerialsvideo/";
              $papertmp=$_FILES['coursematerialsvideo']['tmp_name']; 
            $temp = explode(".", $_FILES["coursematerialsvideo"]["name"]);
           
            $exampapername =$staffid.round(microtime(true)) . '.' . strtolower(end($temp));
           move_uploaded_file($_FILES["coursematerialsvideo"]["tmp_name"], $target_dir . $exampapername);
            }

              
              $state=$teachersinsert->insert_10fields('coursematerialsvideo', 'levelid', $levelid, 'optionid', $optionid, 'semesterid', $semesterid, 'sessionid', $sessionid, 'instructorudate', $instructorudate, 'instructorid', $staffid, 'courseid', $courseid, 'dlink',  $exampapername, 'description',  $description, 'odate', $odate);
...
//Checking whether logo was uploaded(browsed)
  if($coursematerialsvideo!=""){
  $target_dir = "../schoolhelp/uploads/coursematerialsvideo/";
  $exampapertmp=$_FILES['coursematerialsvideo']['tmp_name']; 
  $temp = explode(".", $_FILES["coursematerialsvideo"]["name"]);
  $exampapername =strtolower($coursematerialsvideo).round(microtime(true)) . '.' . end($temp);
  move_uploaded_file($_FILES["coursematerialsvideo"]["tmp_name"], $target_dir. $exampapername);
...
$state= $schoolhelpupdate->update_threefields('coursematerialsvideo', 'cm_id', $cm_id, 'description',  $description,  'dlink',  $exampapername,  'instructorudate', $instructorudate);
			$sql=$state.":: Update Made, affected records = 1";
...
<?php
   ...
   $filename=trim(isset($_GET['filename'])?$_GET['filename']:false);
    ...
    $state=$schoolhelpupdate->delete_result('coursematerialsvideo', 'cm_id', $recordid);
...
?>
	...
	if ($page == "")
	{
        ...
        <div style=" width:80%; margin-left:auto; margin-right:auto; margin-top:2%;"><?php if($sql){ echo "<span class='glyphicon glyphicon-info-sign' style='color:green'></span><span style='color:green'>$sql</span>";  }?></div>
			...
			<?php
               $teacherquestion=$SHteacher->teacheredit5order('coursematerialsvideo', 'courseid', $courseid, 'levelid', $levelid, 'optionid', $optionid, 'semesterid', $semesterid, 'sessionid', $sessionid, 'odate', 'DESC');
            ...
            ?> 
                ...
                <tr >  
                 ...
                 if($teacherquestionrec['instructorudate']>$teacherquestionrec['udate']){ 
                    ...
                    <tr>
                    <td>Uploaded file</td><td align="center"> <a target="new" class="embed" href="../schoolhelp/uploads/coursematerialsvideo/<?php echo $teacherquestionrec['dlink'];?>">Click on it to Preview <span class="glyphicon glyphicon-arrow-right"></span><?php echo $teacherquestionrec['dlink'];?></a></td>
                    </tr>
                    <tr>
            ...
            <div style=" width:80%; margin-left:auto; margin-right:auto; margin-bottom:50px;">
             <table style="width:100%">
                <tr>
                    <td>
                        <a class="btn btn-primary" href="?refno=<?php echo $staffid; ?>&tcid=<?php $classinfo ?>">Add Course Material</a>
                    </td>
                </tr>
            </table>
         </div>
                    ...
                    <table class="table" style="border:none">
                     ...
                     <p id="error1" style="display:none; color:#FF0000;">
                        ...
                        Maximum File Size Limit is 1MB.
                                ...
                                <input class="form-control" type="file" name="coursematerialsvideo" id="file_input"  required="required" />
                            </td>
                        </tr>
        ...
        ?>
            ...
            <?php if ($page==3) { 
              ...
              $teachersquestions=$SHteacher->allteacheredit('coursematerialsvideo','cm_id', $recordid);
                      ...
                      <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="file" class="form-control" name="coursematerialsvideo" id="file_input1"/>
                            </td>
                        </tr>
