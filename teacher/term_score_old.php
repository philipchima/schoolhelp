    ...
    $scoretblname="score".$scoredeptid;
      ...
      $assessmentid="";
        ...
        $assessmentdata1=$SHteacher->allteacheredit('assessment', 'departmentid', $scoredeptid);
                            ...
                            $state= $tableUpdate->update_score($scoretblname, 'scoreid', $scoreid, 'score',  $score, 'instructoid', $staffid, 'udate', $udate);
                              ...
                              if ($score!="") {
                                //Inserting New Score
                                  ...
                                  $state=$tablestudents->insert_score($scoretblname, $sessionid, $semesterid, $levelid, $optionid, $stid, $courseid, $assessmentid, $score, 'instructoid', $staffid, 'udate', $udate, $odate);
