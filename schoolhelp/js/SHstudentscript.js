...
// Retrieving Some fields
  function addingfields(tabletoadd, tabletoaddfield, tabletocheck, tabletocheckfield, tabletocheckgetfield, tabletocheckid, section){
    ...
    $.ajax({
      url: '../phpclass/SHstudentserver.php',
      type: 'POST',
      data: {
        'section':section,
...
function funceditstudentm(schoolhelp, id, optionid, levelid, type){

       if (confirm("Please make sure you are not changing the department(school), or level(class) of a student if he or has result already in the system!!! \n Do you wish to continue?")) {
          window.location.href="?page=3&schoolhelp="+schoolhelp+"&id="+id+"&levelid="+levelid+"&type="+type+"&optionid="+optionid;
        }
}
...
function funcdeletestudentm(schoolhelp, id, passport, optionid, levelid, type){

       if (confirm("Caution, Deletion of this student record will cause lost of all his results!!!\n Do you want to continue?")) {
          window.location.href="?page=6&schoolhelp="+schoolhelp+"&id="+id+"&passport="+passport+"&levelid="+levelid+"&type="+type+"&optionid="+optionid;
        }
}
...
function funcresetpasswordm(schoolhelp, id, optionid, levelid, type){

       if (confirm("Resetting of this person's password to 'password' will automatically disengage this person, if not informed, Do you want to continue?")) {
          window.location.href="?page=9&schoolhelp="+schoolhelp+"&id="+id+"&levelid="+levelid+"&type="+type+"&optionid="+optionid;
        }
}
