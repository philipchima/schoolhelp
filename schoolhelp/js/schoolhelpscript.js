...
// Retrieving Some fields
  function addingfields(tabletoadd, tabletoaddfield, tabletocheck, tabletocheckfield, tabletocheckgetfield, tabletocheckid, section){
    ...
    $.ajax({
      url: '../phpclass/schoolhelpserver.php',
      type: 'POST',
      data: {
        'section':section,
...
//This Updating 3 fields with  with one check

  function updating3field(tablename, fieldname, fieldvalue, updatefield, updatevalue, updatefield1, updatevalue1, updatefield2, updatevalue2, section){
    $("#waitprocessing").show();
...
function funcactivateposition(schoolhelp, id, departmentid){
       
       if (confirm("Do you want to make this record active for this Department?")) {
          window.location.href="?page=7&schoolhelp="+schoolhelp+"&id="+id+"&departmentid="+departmentid;
        }
}
...
function funcdelete(schoolhelp, id, passport){
       ...
       if (confirm("Deletion of this record may cause incompleteness in result related reports and other vital records!!!\n Do you want to continue?")) {
...
function funcdeletestaff(schoolhelp, id, passport, staffid){
