...
$pagename="Timetable Schedule Types";
...
//Checking Whetter Exam type has been added
 $records=$SHtimetableOOP->alltimetableedit2('timetabletype', 'typename', $name, 'departmentid', $departmentid);
    if (is_array($records)) {
...
$insertedrec+=1;
$state=$tableInsert->insert_6fields('timetabletype', 'departmentid', $departmentid, 'typename', $name, 'description', $description, 'operatorid', $schoolhelp, 'udate', $udate, 'odate', $odate);
...
$state=$tableUpdate->update_fourfields('timetabletype', 'timetabletypeid', $timetabletypeid, 'departmentid', $departmentid, 'typename',  $typename, 'description', $description, 'operatorid', $schoolhelp);
...
if ($page==6) {
  ...
  if ($dashdelete_d==1) {
   ...
   $timetabletypeid=trim(isset($_GET['id'])?$_GET['id']:false);
   //$photo=trim(isset($_GET['photo'])?$_GET['photo']:false);
   $tableUpdate= new updateTable;
    $state=$tableUpdate->delete_timetable('timetabletype', 'timetabletypeid', $timetabletypeid);
                ...
                <div class="x_panel">
                  <div class="x_title" style="background: #61dc42; padding-top: 10px; border-radius: 6px;">
                    ...
                    <ul class="nav navbar-right panel_toolbox" style="">
                      ...
                      <li><a href="#" data-toggle="modal" data-target="#myModal" ><i class="fa fa-plus"></i> Add Timetable Type</a>
                      </li>
                      <?php } ?>
                          <li ><a  href="?schoolhelp=<?php echo $schoolhelp; ?>"><i class="fa fa-book"></i> View Timetable Type</a>
                      </li>
                        </li>
                    ...
                    <table id="datatable-buttons" style="width:100%" class="table table-striped table-bordered table-responsive">
                      ...
                      <tbody>
                        <?php $k=0; 
                              ...
                              $records=$SHtimetableOOP->alltimetable('timetabletype', 'timetabletypeid', 'DESC');
                              if (is_array($records)) {
                                $k1=0;
                              ...
                              //Getting Admin Detials
                                ...
                                ?>
                                      <tr>
                                        ...
                                        <td><?php echo  $fieldrecord['typename']; ?></td>
                                        <td><?php echo  $fieldrecord['description']; ?></td>
                                     
                                         <td><button onclick="funcprint('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['timetabletypeid']; ?>')"><center><i class="fa fa-print" style="color:green; font-size:2em"></i></center></button></td>
                                          <?php if ($dashedit_d==1) { ?>
                                        <td><button onclick="funcedit('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['timetabletypeid']; ?>')"><center><i class="fa fa-edit" style="color:#d2dc2a; font-size:2em"></i></center></button></td>
                                        <?php } ?>
                                         <?php if ($dashdelete_d==1) { ?>
                                        <td><button onclick="funcdelete('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['timetabletypeid']; ?>','');"><center><i class="fa fa-trash" style="color:red; font-size:2em"></i></center></button></td>
                                        <?php } ?>
                  ...
                  <form enctype="multipart/form-data" action="?page=2&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="frmmedtreatmentid"  class="form-horizontal form-label-left" >
                    ...
                    <div class="form-group">
                     ...
                     <?php $count=0; $u=1; while($numberoffields>=1){
                       ...
                       <hr>
                     <div class="form-group">
                        <label for="typename" class="control-label col-md-3 col-sm-3 col-xs-12">Type of Timetable<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="typename" class="form-control col-md-7 col-xs-12" placeholder="please enter Exam or Lecture or special training" name="typename[]" required="required" type="text">
                        </div>
                      </div>
                 ...
                 <?php } ?>
                  ...
                  if($page==3) {
                    $timetabletypeid=trim(isset($_GET['id'])?$_GET['id']:false);
                   $records=$SHtimetableOOP->alltimetableedit('timetabletype', 'timetabletypeid', $timetabletypeid);
                              if (is_array($records)) {
                                
                              foreach($records as $fieldrecord){
                                $description=trim($fieldrecord['description']);
                                $typename=trim($fieldrecord['typename']);
                  ...
                  <form enctype="multipart/form-data" action="?page=4&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="forminstitutionid"  class="form-horizontal form-label-left" >
                    <input id="timetabletypeid" class="form-control col-md-7 col-xs-12" type="hidden" name="timetabletypeid" required="required" value="<?php echo $timetabletypeid; ?>">
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        <label for="typename" class="control-label col-md-3 col-sm-3 col-xs-12">Type of Timetable<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="typename" class="form-control col-md-7 col-xs-12" placeholder="please enter Exam or Lecture or special training" name="typename" required="required" type="text" value="<?php echo $typename; ?>"  onblur="return updatevalidity1('timetabletype', 'Timetable type', '<?php echo $timetabletypeid; ?>', 'timetabletypeid', 'typename', this.value, 'departmentid',  $('#departmentid').val(), 'updating', $(this).attr('id'));" >
                        </div>
                      </div>
                        ...
                        <div class="col-xs-12">
                          ...
                          <div class="table-responsive">
                            <table class="table">
                              <tbody>
                                <tr>
                                  <th style="width:50%">Timetable Type Name</th>
