...
$state=$tableinstructorcourses->insert_instructorcourses($staffid, $departmentid,  $courseid, $schoolhelp, $odate);
...
$state=$tableicourse->update_instructorcourses($icourseid, $staffid, $departmentid, $courseid, $schoolhelp);
                  ...
                  <form enctype="multipart/form-data" action="?page=2&schoolhelp=<?php echo $schoolhelp; ?>&staffid=<?php echo $staffid; ?>" method="POST"  id="forminstitutionid"  class="form-horizontal form-label-left" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select  id="departmentid" required="required" name="departmentid" class="form-control col-md-7 col-xs-12" onchange="retrieveselection3('course', 'departmentid', this.value, 0, 0, 'retrieveselection3', 'retrieveselection3', 'subjcourse');">
                 ...
                 <?php } ?>
                  ...
                  <form enctype="multipart/form-data" action="?page=4&schoolhelp=<?php echo $schoolhelp; ?>&staffid=<?php echo $staffid; ?>" method="POST"  id="forminstitutionid"  class="form-horizontal form-label-left" >
                      ...
                      <div  id="retrieveselection3">
                                  ...
                                  <?php $retrievedata=$schoolhelpDH->alldashedit('course', 'departmentid', $departmentid);
