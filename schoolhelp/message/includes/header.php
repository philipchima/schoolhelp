...
$schoolhelpheader= new classMessage;
$adminid=trim(isset($_GET['schoolhelp'])?$_GET['schoolhelp']:false);
$schoolhelp =trim(isset($_SESSION['schoolhelp'.$adminid])?$_SESSION['schoolhelp'.$adminid]:false);

$previlleges=$schoolhelpheader->allmessageedit('adminpersons', 'adminid', $schoolhelp);
...
$instilogo="";
   ...
   $records1=$schoolhelpheader->allmessageedit('adminpersons', 'adminid', $schoolhelp);
                     ...
                     foreach($records1 as $fieldrecord1){
                               ...
                               if ($admintype1==1) {
                                  ...
                                  //To retrieve any schools logo
                                   $logodata1=$schoolhelpheader->allmessage('institution', 'i_id',  'ASC');
                                  ...
                                  //Getting Staff ID
                                        $signatorydata1=$schoolhelpheader->allmessageedit('signatoryposition', 'signatorypositionid',  $signatorypositionid1);
                                           if(is_array($signatorydata1)){
                                             ...
                                             $logodata1=$schoolhelpheader->allmessageedit('institution', 'departmentid',  $departmentid1);
                                           if(is_array($logodata1)){
                                              foreach($logodata1 as $logorec1){
                                                $photologo=$logorec1['instilogo'];
                                                $instilogo="../images/logo/".$photologo;
                                        ...
                                        //Getting Staff ID
                                        $staffdata1=$schoolhelpheader->allmessageedit('staff', 'staffid',  $staffid1);
                                           if(is_array($staffdata1)){
                                            ...
                                            //getting department Name
                                             $departmentdata1=$schoolhelpheader->allmessageedit('department', 'did',  $departmentid1);
        ...
        <div class="col-md-3 left_col" >
          <div class="left_col scroll-view">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <?php if ($settings==1) { ?>
                       <li><a href="../settings?schoolhelp=<?php echo $schoolhelp; ?>">Setting</a></li>
                      <?php } ?>  
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-table"></i> Student <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <?php if ($student==1) { ?>
                      <li><a href="?schoolhelp=<?php echo $schoolhelp; ?>">Student</a></li>
                      <?php } ?> 
                      <?php if ($guardian==1) { ?>
            ...
            <div class="sidebar-footer hidden-small">
              <a data-toggle="tooltip" data-placement="top" title="settings" href="../Settings?schoolhelp=<?php echo $schoolhelp; ?>">
