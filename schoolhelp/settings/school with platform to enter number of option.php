...
$subjnum=trim(isset($_POST['optionnum'.$deptcount])?$_POST['optionnum'.$deptcount]:false);
$tableDepartment=new insertTable;
$state=$tableDepartment->insert_department($departmentname, $years, $grades, $assnum, $signnum, $subjnum, $optionnum, $description, $schoolhelp, $xdate);
}
...
$optionnum=trim(isset($_POST['optionnum'])?$_POST['optionnum']:false);

$did=trim(isset($_POST['did'])?$_POST['did']:false);
$tableDepartment=new updateTable;
$state=$tableDepartment->update_department($did, $departmentname, $years, $grades, $assnum, $signnum, $subjnum, $optionnum, $description, $schoolhelp, $xdate);
                              ...
                              $adminname= $admindata['surname']. " ".$admindata['othername'] ;
                                ...
                                ?>
                                      <tr>
                                        ...
                                        <td><?php echo  $fieldrecord['optionnum']; ?></td>
                  ...
                  <form action="?page=2&schoolhelp=<?php echo $schoolhelp; ?>" method="POST" id="schools" data-parsley-validate class="form-horizontal form-label-left" onSubmit="return updatevalidity('department', 'deptname', this.value, 'updating', $(this).attr('id'));">
                     ...
                     <?php $count=0; while($numberoffields>=1){
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="signnum">No of Option<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="optionnum<?php echo $count; ?>" id="optionnum"   class="form-control col-md-7 col-xs-12" required="required" placeholder="Enter number of Option in this department; eg: 1 or 2 or 3,4,5...">  
                        </div>
                      </div>
                  ...
                  <form action="?page=4&schoolhelp=<?php echo $schoolhelp; ?>" method="POST" id="schools" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="optionnum" id="optionnum"  class="form-control col-md-7 col-xs-12" required="required" placeholder="Enter number of Options in this department; eg: 1 or 2 or 3,4,5..." value="<?php echo $record['optionnum']; ?>">  
                        </div>
                      </div>
                            ...
                            <table class="table">
                              <tbody>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                  <th>No of Option</th>
                                  <td><?php echo $record['numoption']; ?></td>
                                </tr>
                                 <tr>
                                  <th>No of Subject</th>
                                  <td><?php echo $record['subjnum']; ?></td>
                                </tr>
