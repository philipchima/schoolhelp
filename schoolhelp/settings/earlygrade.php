...
$pagename="Early Class Grade";
$tablename="earlygrade";
...
if($page==2) {
  ...
  $gradename=trim(isset($_POST['gradename'])?$_POST['gradename']:false);
  $graderank=trim(isset($_POST['graderank'])?$_POST['graderank']:false);
 ...
 $state=$tbldomaintype->insert_6fields($tablename, 'levelid', $levelid, 'gradename', $gradename, 'description', $description, 'graderank', $graderank, 'operatorid', $schoolhelp, 'odate', $odate);
...
if($page==4) {
  if($settingedit_s==1) {
 //getting array ofrecords
 $earlygradeid=trim(isset($_POST['earlygradeid'])?$_POST['earlygradeid']:false);
...
$state=$tablesignatorycomment->update_6fields($tablename, 'levelid', $levelid, 'gradename', $gradename, 'description', $description, 'graderank', $graderank, 'operatorid', $schoolhelp, 'earlygradeid', $earlygradeid);
...
if ($page==6) {
  ...
  $earlygradeid=trim(isset($_GET['id'])?$_GET['id']:false);
   
   $schoolhelpDHd= new TblDeleterow;
    $state=$schoolhelpDHd->delete_setting('earlygrade', 'earlygradeid', $earlygradeid);
                ...
                <div class="x_panel">
                    ...
                    <table id="datatable-buttons" style="width:100%" class="table table-striped table-bordered table-responsive">
                      ...
                      <tbody>
                        <?php $k=0; 
                              ...
                              $records=$schoolhelpsetting->allsetting('earlygrade','earlygradeid','desc');
                              ...
                              $levelname=$deptmethod['levelname'];
                                ...
                                ?>
                                      <tr>
                                        ...
                                        <td title="<?php echo trim($fieldrecord['gradename']); ?>"><?php echo  substr($fieldrecord['gradename'],0, 12); ?></td>  
                                        <td title="<?php echo trim($fieldrecord['description']); ?>"><?php echo  substr($fieldrecord['description'],0, 12); ?></td>  
                                        <td><?php echo  substr($fieldrecord['graderank'],0, 12); ?></td>                      
                                        <?php if ($settingedit_s==1) { ?>
                                         <td><button onclick="funcprint('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['earlygradeid']; ?>')"><center><i class="fa fa-print" style="color:green; font-size:2em"></i></center></button></td>
                                          
                                        <td><button onclick="funcedit('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['earlygradeid']; ?>')"><center><i class="fa fa-edit" style="color:red; font-size:2em"></i></center></button></td>
                                         <?php } if ($settingdelete_s==1) { ?>
                                        <td><button onclick="funcdelete('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['earlygradeid']; ?>','');"><center><i class="fa fa-trash" style="color:red; font-size:2em"></i></center></button></td>
                                        <?php } ?>
                  ...
                  <form enctype="multipart/form-data" action="?page=2&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="formgradeid"  class="form-horizontal form-label-left" >
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label for="remark" class="control-label col-md-3 col-sm-3 col-xs-12">Grade Name<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="gradename" name="gradename"  required="required" class="form-control col-md-7 col-xs-12"  placeholder="Please enter the Early class grade Name" onblur="return updatevalidity1('earlygrade', 'gradename', 'levelid',  this.value, $('#levelid').val(), 'inserting', $(this).attr('id'))">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea  name="description" id="description" class="form-control col-md-7 col-xs-12"   placeholder="Please Enter the Description of this grade"></textarea>
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="graderank" class="control-label col-md-3 col-sm-3 col-xs-12">Grade Rank</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="graderank" name="graderank" type="number"  class="form-control col-md-7 col-xs-12"  placeholder="Please Enter the ranking formation" >
                        </div>
                      </div>
              ...
              <button class="btn btn-primary" type="reset">Reset</button>
                 ...
                 ?>
                  ...
                  if($page==3) {
                    ...
                    $records=$schoolhelpsetting->allsettingedit('earlygrade','earlygradeid',$earlygradeid);
                  ...
                  <form enctype="multipart/form-data" action="?page=4&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="earlygrade"  class="form-horizontal form-label-left" >
                      <input type="hidden" name="earlygradeid" value="<?php echo $earlygradeid; ?>">
                       ...
                       <div class="form-group">
                        <label for="remark" class="control-label col-md-3 col-sm-3 col-xs-12">Grade Name</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="gradename" name="gradename" type="text" required="required" class="form-control col-md-7 col-xs-12"  placeholder="Please enter the graderank type name" onblur="return updatevalidity1('earlygrade', 'gradename', 'levelid',  this.value, $('#levelid').val(), 'updating', $(this).attr('id'))" value="<?php echo $fieldrecord['gradename']; ?>">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Description</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea  name="description" id="description" class="form-control col-md-7 col-xs-12"  required="required" placeholder="Please Describe the this grade"><?php echo $fieldrecord['description']; ?></textarea>
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="remark" class="control-label col-md-3 col-sm-3 col-xs-12">Grade Rank</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="graderank" name="graderank" type="number" required="required" class="form-control col-md-7 col-xs-12"  placeholder="Please enter the no of graderank under this graderank type" value="<?php echo $fieldrecord['graderank']; ?>">
                        </div>
                      </div>
                    ...
                    <section class="content invoice">
                      ...
                      <div class="row">
                        <div class="col-xs-12 invoice-header">
                          <h1>
                                          <i class="fa fa-tag" style="color:#063"></i> <?php echo $fieldrecord['gradename']; ?>.
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12">
                          <hr>
                          <center><p class="lead schoolhelpcolor"><b><?php echo $levelname.' '.$fieldrecord['gradename']; ?>   Details</p></b></center>
                          <div class="table-responsive">
                            <table class="table">
                              <tbody>
                                ...
                                <tr>
                                  <th >Category Sub:</th>
                                  <td><?php echo $fieldrecord['gradename']; ?></td>
                                </tr>
                                <tr>
                                  <th>Description:</th>
                                 ...
                                 <tr>
                                  <th>No of graderank</th>
                                  <td><?php echo $fieldrecord['graderank']; ?></td>
                                </tr>
                      ...
                      <div class="row no-print">
                        <div class="col-xs-12">
                          ...
                          <?php if ($settingedit_s==1) { ?>
                          <div class="col-xs-6"><a class="btn btn-primary "  href="?page=3&schoolhelp=<?php echo $schoolhelp; ?>&id=<?php echo $fieldrecord['earlygradeid']; ?>"><i class="fa fa-edit"></i> Edit</a></div>
                          <?php  } ?>
                        </div>
                      </div>
                    </section>
