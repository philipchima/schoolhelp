...
$schoolhelpheader= new Allsettings;
$adminid=trim(isset($_GET['schoolhelp'])?$_GET['schoolhelp']:false);
$schoolhelp =trim(isset($_SESSION['schoolhelp'.$adminid])?$_SESSION['schoolhelp'.$adminid]:false);

$previlleges=$schoolhelpheader->allsettingedit('adminpersons', 'adminid', $schoolhelp);
if (is_array($previlleges)) {

foreach($previlleges as $actualrecord){
  $pageaccess=trim($actualrecord['settings']);
...
$instilogo="";
   ...
   $records1=$schoolhelpheader->allsettingedit('adminpersons', 'adminid', $schoolhelp);
                     ...
                     foreach($records1 as $fieldrecord1){
                               ...
                               if ($admintype1==1) {
                                  ...
                                  //To retrieve any schools logo
                                   $logodata1=$schoolhelpheader->allsetting('institution', 'i_id',  'ASC');
                                  ...
                                  //Getting Staff ID
                                        $signatorydata1=$schoolhelpheader->allsettingedit('signatoryposition', 'signatorypositionid',  $signatorypositionid1);
                                           if(is_array($signatorydata1)){
                                             ...
                                             $logodata1=$schoolhelpheader->allsettingedit('institution', 'departmentid',  $departmentid1);
                                           if(is_array($logodata1)){
                                              foreach($logodata1 as $logorec1){
                                                $photologo=$logorec1['instilogo'];
                                                $instilogo="../images/logo/".$photologo;
                                        ...
                                        //Getting Staff ID
                                        $staffdata1=$schoolhelpheader->allsettingedit('staff', 'staffid',  $staffid1);
                                           if(is_array($staffdata1)){
                                            ...
                                            //getting department Name
                                             $departmentdata1=$schoolhelpheader->allsettingedit('department', 'did',  $departmentid1);
