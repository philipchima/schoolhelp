...
//getting array ofrecords
 $departmentid=trim(ucwords(isset($_POST['departmentid'])?$_POST['departmentid']:false));
...
$state=$tableDepartment->insert_institution($departmentid, $institutionname, $institutionslogan, 
...
$institutionname=trim(ucwords(isset($_POST['institutionname'])?$_POST['institutionname']:false));
 ...
 $institutionemail=trim(isset($_POST['institutionemail'])?$_POST['institutionemail']:false);
 $institutionregpre=trim(isset($_POST['institutionregpre'])?$_POST['institutionregpre']:false);
 $institutionlogoold=trim(isset($_POST['institutionlogoold'])?$_POST['institutionlogoold']:false);
...
$institutionlogo=$_FILES["institutionlogo"]["name"];
 if($institutionlogo!=""){
    ...
    $institutionlogotmp=$_FILES['institutionlogo']['tmp_name']; 
  $temp = explode(".", $_FILES["institutionlogo"]["name"]);
  $institutionlogoname =preg_replace('/\s+/', '',strtolower($institutionlogo).round(microtime(true)) . '.' . end($temp));
  move_uploaded_file($_FILES["institutionlogo"]["tmp_name"], "../images/logo/" . $institutionlogoname);
...
$state=$tableinstitution->update_institution($i_id, $departmentid, $institutionname, $institutionslogan,  $institutionphone,  $institutionaddress, $institutionemail, $institutionregpre, $institutionlogoname, $schoolhelp);
                ...
                <div class="x_panel">
                    ...
                    <ul class="nav navbar-right panel_toolbox" style="">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                         <li  ><a href="?page=1&schoolhelp=<?php echo $schoolhelp; ?>"  ><i class="fa fa-plus"></i>  Add Institution</a>
                      </li>
                          <li ><a  href="?schoolhelp=<?php echo $schoolhelp; ?>"><i class="fa fa-book"></i>  View Institution</a>
                      </li>
                        </ul>
                      </li>
                  ...
                  <div style="color:#063" <?php if ($state=="failed") {?> style="color:red" <?php } ?> ><b><?php echo $sql; ?></b></div>
                    ...
                    <?php if ($page=="") {?>
                      <div class="x_panel ">
                         <fieldset>
                        <legend style="color:#063">Institution Record</legend>
                        ...
                        <?php $k=0; 
                              ...
                              foreach($records as $fieldrecord){
                                ...
                                ?>
                                      <tr>
                                        <td><?php echo $k; ?></td>
                                        <td style="width:8%"><img src="../images/logo/<?php echo $fieldrecord['instilogo'];  ?>" class="img img-responsive img-rounded"></td>
                    ...
                    <div class="x_panel">
                      <fieldset>
                        <legend style="color:#063">Add Institution</legend>
                  <form enctype="multipart/form-data" action="?page=2&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="forminstitutionid"  class="form-horizontal form-label-left" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select  id="departmentid" required="required" name="departmentid" class="form-control col-md-7 col-xs-12" onchange="return updatevalidity('institution', 'departmentid',  this.value,'updating', $(this).attr('id'));">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Institution Name<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="institutionname" required="required" name="institutionname" class="form-control col-md-7 col-xs-12" onblur="return updatevalidity1('institution', 'instiname', 'departmentid', this.value, $('#departmentis').val(), 'inserting', $(this).attr('id'));">
                        </div>
                      </div>
                     
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Institution Slogan</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="institutionslogan" class="form-control col-md-7 col-xs-12" type="text" name="institutionslogan">
                        </div>
                      </div>
              ...
              <button class="btn btn-primary" type="reset">Reset</button>
                 ...
                 <?php } ?>
                  ...
                  <?php if($page==3) {
                    ...
                    <div class="x_panel">
                      <fieldset>
                        <legend style="color:#063">Edit Institution</legend>
                  <form enctype="multipart/form-data" action="?page=4&schoolhelp=<?php echo $schoolhelp; ?>&i_id=<?php echo $i_id; ?>" method="POST"  id="forminstitutionid"  class="form-horizontal form-label-left" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="institutionname" value="<?php echo $record['instiname']; ?>" required="required" name="institutionname" class="form-control col-md-7 col-xs-12" updatevalidity1('institution', 'instiname', 'departmentid', this.value, $('#departmentis').val(), 'updating', $(this).attr('id'));">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Institution Slogan</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="institutionslogan" class="form-control col-md-7 col-xs-12" type="text" name="institutionslogan" value="<?php echo $record['instislogan']; ?>">
                        </div>
                      </div>
