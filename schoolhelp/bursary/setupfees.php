                    ...
                    <table id="datatable-buttons" style="width:100%" class="table table-striped table-bordered table-responsive">
                      ...
                      <tbody>
                        <?php $k=0; 
                              ...
                              $records=$SHbusaryOOP->allbusary('setupfees', 'setupfeesid', 'DESC');
                              if (is_array($records)) {
                                $k1=0;
                              ...
                              //Getting Admin Detials
                                ...
                                ?>
                                      <tr>
                                        ...
                                        <td><?php echo  $fieldrecord['feename']; ?></td>
                                        <td><?php echo  $fieldrecord['amount']; ?></td>
                                        <td><?php echo  $deptname; ?></td>   
                                        <td><?php if ($fieldrecord['compulsory']==1) { echo  "Compulsory"; }else{ echo "Not Compulsory"; }  ?></td>
                                        <td><?php echo substr($fieldrecord['description'], 0,12); ?></td>
                                     
                                         <td><button onclick="funcprint('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['setupfeesid']; ?>')"><center><i class="fa fa-print" style="color:green; font-size:2em"></i></center></button></td>
                                          <?php if ($dashedit_d==1) { ?>
                                        <td><button onclick="funcedit('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['setupfeesid']; ?>')"><center><i class="fa fa-edit" style="color:#d2dc2a; font-size:2em"></i></center></button></td>
                                        <?php } ?>
                                         <?php if ($dashdelete_d==1) { ?>
                                        <td><button onclick="funcdelete('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['setupfeesid']; ?>','');"><center><i class="fa fa-trash" style="color:red; font-size:2em"></i></center></button></td>
                                        <?php } ?>
