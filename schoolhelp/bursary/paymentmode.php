...
foreach($paymentmode as $typecount=>$typenames){
...
//Checking Whetter Exam type has been added
 $records=$SHbusaryOOP->allbusaryedit2('bursarypaymentmode', 'paymentmode', $name, 'departmentid', $departmentid);
    if (is_array($records)) {
...
$insertedrec+=1;
$state=$tableInsert->insert_6fields('bursarypaymentmode', 'departmentid', $departmentid, 'paymentmode', $name, 'description', $description, 'operatorid', $schoolhelp, 'udate', $udate, 'odate', $odate);
...
if($page==4) {
    $sql="Criminal Suspected";
  if ($dashedit_d==1) {
  $bursarypaymentmodeid=trim(isset($_POST['bursarypaymentmodeid'])?$_POST['bursarypaymentmodeid']:false);
  $paymentmode=trim(isset($_POST['paymentmode'])?$_POST['paymentmode']:false);
  $description=trim(isset($_POST['description'])?$_POST['description']:false);
  $departmentid=trim(isset($_POST['departmentid'])?$_POST['departmentid']:false);
 
$state=$tableUpdate->update_fourfields('bursarypaymentmode', 'bursarypaymentmodeid', $bursarypaymentmodeid, 'departmentid', $departmentid, 'paymentmode',  $paymentmode, 'description', $description, 'operatorid', $schoolhelp);
...
if ($page==6) {
  ...
  if ($dashdelete_d==1) {
   ...
   $bursarypaymentmodeid=trim(isset($_GET['id'])?$_GET['id']:false);
   //$photo=trim(isset($_GET['photo'])?$_GET['photo']:false);
   $tableUpdate= new updateTable;
    $state=$tableUpdate->delete_bursary('bursarypaymentmode', 'bursarypaymentmodeid', $bursarypaymentmodeid);
              ...
              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12" style="margin-bottom: 20px;">
                <div class="x_panel">
                  <div class="x_title" style="background: #61dc42; padding-top: 10px; border-radius: 6px;">
                    ...
                    <ul class="nav navbar-right panel_toolbox" style="">
                      ...
                      <li><a href="#" data-toggle="modal" data-target="#myModal" ><i class="fa fa-plus"></i> Add Payment Mode</a>
                      </li>
                      <?php } ?>
                          <li ><a  href="?schoolhelp=<?php echo $schoolhelp; ?>"><i class="fa fa-book"></i> View Payment Mode</a>
                      </li>
                        </li>
                    ...
                    <table id="datatable-buttons" style="width:100%" class="table table-striped table-bordered table-responsive">
                      ...
                      <tbody>
                        <?php $k=0; 
                              ...
                              $records=$SHbusaryOOP->allbusary('bursarypaymentmode', 'bursarypaymentmodeid', 'DESC');
                              if (is_array($records)) {
                                $k1=0;
                              ...
                              //Getting Admin Detials
                                ...
                                ?>
                                      <tr>
                                        ...
                                        <td><?php echo  $fieldrecord['paymentmode']; ?></td>
                                        <td><?php echo  $fieldrecord['description']; ?></td>
                                     
                                         <td><button onclick="funcprint('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['bursarypaymentmodeid']; ?>')"><center><i class="fa fa-print" style="color:green; font-size:2em"></i></center></button></td>
                                          <?php if ($dashedit_d==1) { ?>
                                        <td><button onclick="funcedit('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['bursarypaymentmodeid']; ?>')"><center><i class="fa fa-edit" style="color:#d2dc2a; font-size:2em"></i></center></button></td>
                                        <?php } ?>
                                         <?php if ($dashdelete_d==1) { ?>
                                        <td><button onclick="funcdelete('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['bursarypaymentmodeid']; ?>');"><center><i class="fa fa-trash" style="color:red; font-size:2em"></i></center></button></td>
                                        <?php } ?>
                  ...
                  <form enctype="multipart/form-data" action="?page=2&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="frmmedtreatmentid"  class="form-horizontal form-label-left" >
                    ...
                    <div class="form-group">
                     ...
                     <?php $count=0; $u=1; while($numberoffields>=1){
                       ...
                       <hr>
                     <div class="form-group">
                        <label for="paymentmode" class="control-label col-md-3 col-sm-3 col-xs-12">Mode of Payment Name<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="paymentmode" class="form-control col-md-7 col-xs-12" placeholder="please enter Payment Mode" name="paymentmode[]"  onblur="return updatevalidity2('bursarypaymentmode', 'Payment mode', '<?php echo $bursarypaymentmodeid; ?>', 'bursarypaymentmodeid', 'paymentmode', this.value, 'departmentid',  $('#departmentid').val(), 'inserting', $(this).attr('id'));" required="required" type="text">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="description" class="form-control col-md-7 col-xs-12"  name="description<?php echo $count; ?>" placeholder="Please describe this Payment Mode"></textarea>
                        </div>
                      </div>
                 ...
                 <?php } ?>
                  ...
                  if($page==3) {
                    $bursarypaymentmodeid=trim(isset($_GET['id'])?$_GET['id']:false);
                   $records=$SHbusaryOOP->allbusaryedit('bursarypaymentmode', 'bursarypaymentmodeid', $bursarypaymentmodeid);
                              if (is_array($records)) {
                                
                              foreach($records as $fieldrecord){
                                $description=trim($fieldrecord['description']);
                                $paymentmode=trim($fieldrecord['paymentmode']);
                  ...
                  <form enctype="multipart/form-data" action="?page=4&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="forminstitutionid"  class="form-horizontal form-label-left" >
                    <input id="bursarypaymentmodeid" class="form-control col-md-7 col-xs-12" type="hidden" name="bursarypaymentmodeid" required="required" value="<?php echo $bursarypaymentmodeid; ?>">
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        <label for="paymentmode" class="control-label col-md-3 col-sm-3 col-xs-12">Mode of Payment<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="paymentmode" class="form-control col-md-7 col-xs-12" placeholder="please enter Your payment Mode" name="paymentmode" required="required" type="text" value="<?php echo $paymentmode; ?>"  onblur="return updatevalidity2('bursarypaymentmode', 'Payment mode', '<?php echo $bursarypaymentmodeid; ?>', 'bursarypaymentmodeid', 'paymentmode', this.value, 'departmentid',  $('#departmentid').val(), 'updating', $(this).attr('id'));" >
                        </div>
                      </div>
                        ...
                        <label for="description" class="control-label col-md-3 col-sm-3 col-xs-12">Description<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="description" class="form-control col-md-7 col-xs-12"  name="description" placeholder="Please describe this kind of Payment Mode"><?php echo $description; ?></textarea>
                        </div>
                      </div>
                ...
                <?php if ($page==5) {
                  ...
                  ?>
                    <div class="x_panel" >
                  <div class="x_title">
                    <h3><?php echo $paymentmode; ?> Mode of Payment Name </h3>
                    ...
                    <section class="content invoice">
                      ...
                      <div class="row">
                        <div class="col-xs-12 invoice-header">
                          <h3>
                                          <i class="fa fa-tag" style="color:#063"></i> <?php echo $paymentmode ; ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12">
                          <hr>
                          <center><p class="lead schoolhelpcolor"><b>Payment Mode Details</p></b></center>
                          <div class="table-responsive">
                            <table class="table">
                              <tbody>
                                <tr>
                                  <th style="width:50%">Mode of Payment Name</th>
