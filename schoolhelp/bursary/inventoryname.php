...
echo $setupinventoryid=trim(isset($_POST['setupinventoryid'.$typecount])?$_POST['setupinventoryid'.$typecount]:false);
  
//Checking Whetter this inventory has been added
 $records=$SHbusaryOOP->allbusaryedit2('inventoryname', 'inventoryname', $name, 'setupinventoryid', $setupinventoryid);
    if (is_array($records)) {
                ...
                <div class="x_panel">
                    ...
                    <table id="datatable-buttons" style="width:100%" class="table table-striped table-bordered table-responsive">
                      ...
                      <tbody>
                        <?php $k=0; 
                              ...
                              $records=$SHbusaryOOP->allbusary('inventoryname', 'inventorynameid', 'DESC');
                              if (is_array($records)) {
                                $k1=0;
                  ...
                  <form enctype="multipart/form-data" action="?page=2&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="frmmedtreatmentid"  class="form-horizontal form-label-left" >
                     ...
                     <?php $count=0; $u=1; while($numberoffields>=1){
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select  id="setupinventoryid<?php echo $count; ?>" required="required" name="setupinventoryid<?php echo $count; ?>" class="form-control col-md-7 col-xs-12" >
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="description" class="form-control col-md-7 col-xs-12"  name="description<?php echo $count; ?>" placeholder="Please describe the Inventory"></textarea>
                        </div>
                      </div>
