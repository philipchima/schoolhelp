...
if($page==4) {
    $sql="Criminal Suspected";
  if ($dashedit_d==1) {
  $bursarybankid=trim(isset($_POST['bursarybankid'])?$_POST['bursarybankid']:false);
  $bankname=trim(isset($_POST['bankname'])?$_POST['bankname']:false);
  $accountname=trim(isset($_POST['accountname'])?$_POST['accountname']:false);
  $accountno=trim(isset($_POST['accountno'])?$_POST['accountno']:false);
  $description=trim(isset($_POST['description'])?$_POST['description']:false);
  $departmentid=trim(isset($_POST['departmentid'])?$_POST['departmentid']:false);
 
$state=$tableUpdate->update_sixfields('bursarybanks', 'bursarybankid', $bursarybankid, 'departmentid', $departmentid, 'bankname',  $bankname, 'accountname', $accountname, 'accountno', $accountno, 'description', $description, 'operatorid', $schoolhelp);
                ...
                <div class="x_panel">
                  <div class="x_title" style="background: #61dc42; padding-top: 10px; border-radius: 6px;">
                    ...
                    <ul class="nav navbar-right panel_toolbox" style="">
                      ...
                      <li><a href="#" data-toggle="modal" data-target="#myModal" ><i class="fa fa-plus"></i> Add Bank</a>
                      </li>
                      <?php } ?>
                          <li ><a  href="?schoolhelp=<?php echo $schoolhelp; ?>"><i class="fa fa-book"></i> View Bank</a>
                      </li>
                        </li>
                    ...
                    <table id="datatable-buttons" style="width:100%" class="table table-striped table-bordered table-responsive">
                      ...
                      <tbody>
                        <?php $k=0; 
                              ...
                              $records=$SHbusaryOOP->allbusary('bursarybanks', 'bursarybankid', 'DESC');
                              if (is_array($records)) {
                                $k1=0;
                              ...
                              //Getting Admin Detials
                                ...
                                ?>
                                      <tr>
                                        ...
                                        <td><?php echo  $fieldrecord['bankname']; ?></td>
                                        <td><?php echo  $fieldrecord['accountname']; ?></td>
                                        <td><?php echo  $fieldrecord['accountno']; ?></td>
                                        <td><?php echo  $fieldrecord['description']; ?></td>
                                     
                                         <td><button onclick="funcprint('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['bursarybankid']; ?>')"><center><i class="fa fa-print" style="color:green; font-size:2em"></i></center></button></td>
                                          <?php if ($dashedit_d==1) { ?>
                                        <td><button onclick="funcedit('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['bursarybankid']; ?>')"><center><i class="fa fa-edit" style="color:#d2dc2a; font-size:2em"></i></center></button></td>
                                        <?php } ?>
                                         <?php if ($dashdelete_d==1) { ?>
                                        <td><button onclick="funcdelete('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['bursarybankid']; ?>');"><center><i class="fa fa-trash" style="color:red; font-size:2em"></i></center></button></td>
                                        <?php } ?>
                  ...
                  <form enctype="multipart/form-data" action="?page=2&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="frmmedtreatmentid"  class="form-horizontal form-label-left" >
                    ...
                    <div class="form-group">
                     ...
                     <?php $count=0; $u=1; while($numberoffields>=1){
                       ...
                       <hr>
                     <div class="form-group">
                        <label for="bankname" class="control-label col-md-3 col-sm-3 col-xs-12">Bank Name<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="bankname" class="form-control col-md-7 col-xs-12" placeholder="please enter Bank Name" name="bankname[]" required="required" type="text">
                        </div>
                      </div>

                       <div class="form-group">
                        <label for="bankname" class="control-label col-md-3 col-sm-3 col-xs-12">Account Name<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="accountname" class="form-control col-md-7 col-xs-12" placeholder="please enter Account Name" name="accountname[]" required="required" type="text">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="bankname" class="control-label col-md-3 col-sm-3 col-xs-12">Account No<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="accountno" class="form-control col-md-7 col-xs-12" placeholder="please enter Account No" name="accountno[]" required="required" type="text"  onblur="return updatevalidity2('bursarybanks', 'Account No', '<?php echo $bursarybankid; ?>', 'bursarybankid', 'accountno', this.value, 'departmentid',  $('#departmentid').val(), 'inserting', $(this).attr('id'));">
                        </div>
                      </div>
                        <div class="form-group">
                        <label for="description" class="control-label col-md-3 col-sm-3 col-xs-12">Description<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="description" class="form-control col-md-7 col-xs-12"  name="description<?php echo $count; ?>" placeholder="Please describe this Bank"></textarea>
                        </div>
                      </div>
                 ...
                 <?php } ?>
                  ...
                  <form enctype="multipart/form-data" action="?page=4&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="forminstitutionid"  class="form-horizontal form-label-left" >
                    <input id="bursarybankid" class="form-control col-md-7 col-xs-12" type="hidden" name="bursarybankid" required="required" value="<?php echo $bursarybankid; ?>">
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input id="bankname" class="form-control col-md-7 col-xs-12" placeholder="please enter Bank Name" name="bankname" required="required" type="text" value="<?php echo $bankname; ?>">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input id="accountname" class="form-control col-md-7 col-xs-12" placeholder="please enter Account Name" name="accountname" required="required" type="text" value="<?php echo $accountname; ?>">
                        </div>
                      </div>

                       <div class="form-group">
                        <label for="accountno" class="control-label col-md-3 col-sm-3 col-xs-12">Account No<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">

                          <input id="accountno" class="form-control col-md-7 col-xs-12" placeholder="please enter Account No" name="accountno" required="required" type="text" value="<?php echo $accountno; ?>"  onblur="return updatevalidity2('bursarybanks', 'Account No', '<?php echo $bursarybankid; ?>', 'bursarybankid', 'accountno', this.value, 'departmentid',  $('#departmentid').val(), 'updating', $(this).attr('id'));" >
                        </div>
                      </div>
                        ...
                        <label for="description" class="control-label col-md-3 col-sm-3 col-xs-12">Description<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="description" class="form-control col-md-7 col-xs-12"  name="description" placeholder="Please describe this kind of Bank"><?php echo $description; ?></textarea>
                        </div>
                      </div>
