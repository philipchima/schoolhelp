...
$awardsid=trim(isset($_POST['awardsid'])?$_POST['awardsid']:false);
...
$state=$tableUpdate->update_news($awardsid, $topic, $content,  $photoname, $schoolhelp);
...
if ($page==6) {
   $awardsid=trim(isset($_GET['id'])?$_GET['id']:false);
   $photo=trim(isset($_GET['photo'])?$_GET['photo']:false);
   
    $state=$tableUpdate->delete_web('awards', 'awardsid', $awardsid);
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12" style="margin-bottom: 20px;">
                <div class="x_panel">
                    ...
                    <table id="datatable-buttons" style="width:100%" class="table table-striped table-bordered table-responsive">
                      ...
                      <tbody>
                        <?php $k=0; 
                              ...
                              $records=$datas->allweb('awards', 'awardsid', 'DESC');
                              if (isset($records)) {
                              ...
                              foreach($records as $fieldrecord){
                                ...
                                ?>
                                      <tr>
                                        <td><?php echo  $k; ?></td>
                                        <td style="width:15%"><img src="uploads/awards/<?php echo  $fieldrecord['photo']; ?>" class="img img-responsive img-rounded"></td>
                                        ...
                                        <td><?php echo  substr($fieldrecord['content'],0, 12); ?></td>
                                         ...
                                         <td><button onclick="funcprint('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['awardsid']; ?>')"><center><i class="fa fa-print" style="color:green; font-size:2em"></i></center></button></td>
                                        <td><button onclick="funcedit('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['awardsid']; ?>')"><center><i class="fa fa-edit" style="color:yellow; font-size:2em"></i></center></button></td>
                                        <td><button onclick="funcdelete('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['awardsid']; ?>','<?php echo $fieldrecord['photo']; ?>')"><center><i class="fa fa-trash" style="color:red; font-size:2em"></i></center></button></td>
                  ...
                  <form enctype="multipart/form-data" action="?page=2&schoophelp=<?php echo $schoolhelp; ?>" method="POST"  id="awardsid"  class="form-horizontal form-label-left" >

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Topic<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="topic" required="required" name="topic" class="form-control col-md-7 col-xs-12" onblur="return updatevalidity('awards', 'topic', this.value, 'inserting', $(this).attr('id'));">
                        </div>
                      </div>
              ...
              <button class="btn btn-primary" type="reset">Reset</button>
                 ...
                 <?php } ?>
                  ...
                  <?php if($page==3) {
                    ...
                    $newsdata=$datas->allwebedit('awards', 'awardsid',  $awardsid);
                    ...
                    <div class="x_panel">
                      <fieldset>
                        <legend style="color:#063">Edit awards</legend>
                  <form enctype="multipart/form-data" action="?page=4&schoophelp=<?php echo $schoolhelp; ?>&i_id=<?php echo $awardsid; ?>" method="POST"  id="awardsid"  class="form-horizontal form-label-left" >
                      <input type="hidden" name="awardsid" value="<?php echo $awardsid; ?>">
                      <input type="hidden" name="newsphotoold" value="<?php echo $photo; ?>">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Topic<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="topic" value="<?php echo $topic; ?>" required="required" name="topic" class="form-control col-md-7 col-xs-12" onblur="return updatevalidity('awards', 'topic', this.value, 'updating', $(this).attr('awardsid'));">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="file-field">
                            <img  height="100" width="100" id="showimage"  <?php if($photo!=""){ ?> src="uploads/awards/<?php echo $photo;  ?>" style="display: block;" <?php } ?> >
                              <input type="file" name="photo"  id="photo" class="form-control col-md-7 col-xs-12"  onchange="readURL(this, $(this).attr('id'),  'showimage');">
                        </div>
                      </div>
                      <p id="error1" style="display:none; color:#FF0000;">
                    ...
                    <section class="content invoice">
                      ...
                      <div class="row invoice-info">
                        ...
                        <div class="col-sm-6 col-lg-6 col-xs-6 invoice-col">
                         <img id="userimage" <?php if ($photo!="") {?> style="display: block" src="uploads/awards/<?php echo $photo ?>" <?php } ?> class="img img-responsive img-thumbnail" >
                        </div>
                        <!-- /.col -->
