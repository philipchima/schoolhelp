...
$schoolhelpsetting=new classResult;
$previllages=$schoolhelpsetting->allresultedit('adminpersons', 'adminid', $schoolhelp);
foreach($previllages as $actualrecord){
  $pageaccess=trim($actualrecord['resultactivation_r']);
  $resultedit_r=trim($actualrecord['resultadd_r']);
...
if($page==4) {
   ...
   if($resultedit_r==1) {
   $actid=trim(isset($_POST['actid'])?$_POST['actid']:false);
   $name=ucwords(trim(isset($_POST['name'])?$_POST['name']:false));
   $description=trim(isset($_POST['description'])?$_POST['description']:false);
...
if ($page==6) {
  $actid=trim(isset($_GET['id'])?$_GET['id']:false);
   ...
   $schoolhelpsettingd= new updateTable;
    $state=$schoolhelpsettingd->delete_setting('resultactivations', 'actid', $actid);
...
if ($page==7) {
  ...
  if ($status==1) {
   ...
   $schoolhelpsetting1=new updatetable;
    $state=$schoolhelpsetting1->updatingall3('resultactivations', 'status', $status, 'actid', $actid, $schoolhelp);
            ...
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title" style="background: #61dc42; padding-top: 10px; border-radius: 6px;">
                    ...
                    <ul class="nav navbar-right panel_toolbox" style="">
                      ...
                      <li><a class="btn btn-success " href="index?schoolhelp=<?php echo $schoolhelp; ?>"><i class="fa fa-chevron-up">Result Dashboard</i></a>
                      </li>
                      <li class="dropdown">
                    ...
                    <table id="datatable-buttons" style="width:100%" class="table table-striped table-bordered table-responsive">
                      ...
                      <tbody>
                        <?php $k=0; 
                             ...
                             $records=$schoolhelpsetting->allresult('resultactivations', 'actid', 'ASC');
                             $staffsurname="";
                              $staffothername="";
                              if (is_array($records)) {
                              ...
                              foreach($records as $fieldrecord){
                                ...
                                ?>
                                      <tr title="<?php echo  $fieldrecord['description']; ?>">
                                        <td><?php echo $k; ?></td>
                  ...
                  <form enctype="multipart/form-data" action="?page=2&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="actid"  class="form-horizontal form-label-left" >
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input id="name" class="form-control col-md-7 col-xs-12" type="text" name="name"  placeholder="Please enter the position name" required="required"  onblur="return updatevalidity('resultactivations', 'titlename', this.value, 'inserting', $(this).attr('id'));">
                                    </div>
                                  </div>
              ...
              <button class="btn btn-primary" type="reset">Reset</button>
                 ...
                 <?php } ?>
                  ...
                  <?php if($page==3) {
                    $actid=trim(isset($_GET['id'])?$_GET['id']:false);
                     $records=$schoolhelpsetting->allresultedit('resultactivations', 'actid', $actid);
                  ...
                  <form enctype="multipart/form-data" action="?page=4&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="actid"  class="form-horizontal form-label-left" >
                      <input type="hidden" name="actid" value="<?php echo $actid; ?>">
                                  ...
                                  <div class="form-group">
                                    <label for="positionname" class="control-label col-md-3 col-sm-3 col-xs-12">Name<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input name="name" id="name" class="form-control col-md-7 col-xs-12" type="text" value="<?php echo $fieldrecord['titlename']; ?>" placeholder="Please enter the position name" required="required" onblur="return updatevalidity('resultactivations', 'titlename', this.value, 'updating', $(this).attr('id'));">
                                    </div>
                                  </div>
