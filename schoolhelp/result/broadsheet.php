                    ...
                    <table  style="width:100%; text-align: center" class="table table-striped table-bordered table-responsive" id="printrecord">
                      ...
                      <tbody>
                          ...
                          $equalave="";
                            ...
                            $records=$SHResultOOP->allposi4sort($positiontblname, $levelid, $optionid, $sessionid, $semesterid, $posi_measure, 'DESC');
                              if(is_array($records)) {
                          ...
                          <?php 
                            ...
                            <td style="padding: 0px; margin:0px; border-collapse: collapse;" cellspacing="0px" cellpadding="0px">
                                 ...
                                 $resultdata=$SHResultOOP->allresultedit6($resulttblname, 'stid', $stid, 'levelid', $levelid, 'optionid', $optionid, 'courseid', trim($courserec1['csid']), 'semesterid', $semesterid, 'sessionid', $sessionid);
                          ...
                          $studenttotal+=$actualscore;
                           ...
                           //getting the total of first term score
                            $positioncheck1=$SHResultOOP->allpositionedit5($positiontblname, 'stid', trim($fieldrecord['stid']), 'levelid', $levelid, 'optionid', $optionid, 'semesterid', 1, 'sessionid', $sessionid);
                            ...
                            //Getting the total of second term
                                 $positioncheck2=$SHResultOOP->allpositionedit5($positiontblname, 'stid', trim($fieldrecord['stid']), 'levelid', $levelid, 'optionid', $optionid, 'semesterid', 2, 'sessionid', $sessionid);
                             ...
                             //Getting the total of second term
                                 $positioncheck3=$SHResultOOP->allpositionedit5($positiontblname, 'stid', trim($fieldrecord['stid']), 'levelid', $levelid, 'optionid', $optionid, 'semesterid', 2, 'sessionid', $sessionid);
                           ...
                           <?php } ?>
                              ...
                              <td  style="padding: 0px; margin:0px; border-collapse: collapse;" cellspacing="0px" cellpadding="0px"><?php $totalround=floor($studentaverage); echo $SHResultOOP->grade('remark', $scoredeptid, $totalround); ?></td>                                  
                            </tr>
                     ...
                     <div class="row no-print" style="margin-bottom: 50px">
                        <div class="col-xs-12">
                          ...
                          <div class="col-xs-6"><button type="submit" class="btn btn-success" onClick="return broadsheet1('<?php echo $schoolhelp; ?>', 2)"><i class="fa fa-send"></i> Combined BroadSheet</button></div>
