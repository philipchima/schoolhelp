...
foreach($previlleges as $actualrecord){
  $pageaccess=trim($actualrecord['resultcolor_r']);
...
$state=$tableresultcolor->insert_resultcolor($departmentid, $deptname, $deptaddress,  $labelcolor, $detailcolor, $headbgcolor, $contentbgcolor1, $contentbgcolor2, $backgroundtype, $schoolhelp,  $odate);
...
$state= $tableUpdate->update_resultcolor($departmentid, $deptname, $deptaddress,  $labelcolor, $detailcolor, $headbgcolor, $contentbgcolor1, $contentbgcolor2, $backgroundtype, $schoolhelp, $colorid);
...
if ($resultdelete_r==1) {
   ...
   $passport=trim(isset($_GET['passport'])?$_GET['passport']:false);
    ...
    $state=$tableUpdate->delete_result('resultcolor', 'colorid', $colorid);
                    ...
                    <table id="datatable-buttons"  class="table table-striped table-bordered table-responsive" style="width: 100%">
                      ...
                      <tbody>
                        <?php $k=0; 
                              ...
                              $records=$schoolhelpID->allresult('resultcolor', 'colorid', 'DESC');
                              if (is_array($records)) {
                                ...
                                ?>
                                      <tr>
                                        <td><?php echo  $k; ?></td>
                                          ...
                                          <td align="center" ><?php if($fieldrecord['resultcolorbackground']==1){ echo "School Logo"; }elseif($fieldrecord['resultcolorbackground']==2){ echo "School Name";}else{ echo "Empty"; }?></td>
                                     ...
                                     <tr>
                                        <td><?php echo  $k; ?></td>
                                          ...
                                          <td align="center" bgcolor="<?php  echo $fieldrecord['tablecontentcolor1'];?>"><?php  echo $fieldrecord['tablecontentcolor1']?></td>
                                          <td align="center" bgcolor="<?php echo $fieldrecord['tablecontentcolor2'] ;?>"><?php echo $fieldrecord['tablecontentcolor2'] ;?></td>
                                          <td align="center" ><?php if($fieldrecord['resultbackground']==1){ echo "School Logo"; }elseif($fieldrecord['resultcolorbackground']==2){ echo "School Name";}else{ echo "Empty"; }?></td>
                  ...
                  <form enctype="multipart/form-data" action="?page=2&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="formstid"  class="form-horizontal form-label-left" >
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select  id="departmentid" required="required" name="departmentid" class="form-control col-md-7 col-xs-12" onblur="return updatevalidity('resultcolor', 'departmentid', this.value, 'inserting', $(this).attr('id'));">
              ...
              <button class="btn btn-primary" type="reset">Reset</button>
                 ...
                 <?php } ?>
                  ...
                  <?php if($page==3) {
                    ...
                    $record=$schoolhelpID->allresultedit('resultcolor', 'colorid', $colorid);
                    if(is_array($record)){
                  ...
                  <form enctype="multipart/form-data" action="?page=4&schoolhelp=<?php echo $schoolhelp; ?>" method="POST"  id="formstid"  class="form-horizontal form-label-left" >
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <!-- (table to add name, table to add field to check, table to check name,  table to check field to check, table to check field to get, table to check value to check with, element to append result, fieldid that will appear in the selection, fieldname that will appear in the selection)-->
                          <select  id="departmentid" required="required" name="departmentid" class="form-control col-md-7 col-xs-12" onblur="return updatevalidity('resultcolor', 'departmentid', this.value, 'updating', $(this).attr('id'));">
                            <option value="">--Select Department--</option>
                            <?php
                            $deptrecord=$schoolhelpID->allresult('department','did','ASC');
                            foreach($deptrecord as $deptdata){
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <select name="backgroundtype" class="form-control"  required>
                                      ...
                                      <option value="1" <?php if ($records['resultbackground']==1) {?> selected <?php } ?>>Use School's logo</option>
                                      <option value="2" <?php if ($records['resultbackground']==2) {?> selected <?php } ?>>Use School Name</option>
