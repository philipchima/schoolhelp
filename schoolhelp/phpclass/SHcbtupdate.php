...
class updateTable extends Dbh{
	...
	public function delete_cbt($tablename, $fieldname, $fieldvalue){
    $mysqli = $this->connect();
    ...
    public function delete_cbt2($tablename, $fieldname, $fieldvalue, $fieldname1, $fieldvalue1){
    $mysqli = $this->connect();

     $sql = "DELETE FROM {$tablename} WHERE {$fieldname}='$fieldvalue' and {$fieldname1}='$fieldvalue1'";
    ...
    public function updateonecheckone($tablename, $fieldname, $fieldvalue, $fieldname1, $fieldvalue1){
...
//This all down have not been used
