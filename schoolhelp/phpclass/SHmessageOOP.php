...
class classMessage extends Dbh{

public function allmessage($tablename, $orderfield, $order){
    $mysqli = $this->connect();
...
public function allmessageeditorder($tablename, $fieldname, $fieldvalue, $orderfield, $order){
    $mysqli = $this->connect();
    $data="";
...
public function allmessageedit($tablename, $fieldname, $fieldvalue){
    $mysqli = $this->connect();
    $data="";
...
public function allmessageedit3($tablename, $fieldname, $fieldvalue, $fieldname1, $fieldvalue1, $fieldname2, $fieldvalue2){
    $mysqli = $this->connect();
    $data="";
...
public function messageedit3order($tablename, $fieldname, $fieldvalue, $fieldname1, $fieldvalue1, $fieldname2, $fieldvalue2, $orderfield){
    $mysqli = $this->connect();
    $data="";
...
public function allmessageedit2($tablename, $fieldname, $fieldvalue, $fieldname1, $fieldvalue1){
    $mysqli = $this->connect();
    $data="";
