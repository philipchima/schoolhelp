...
$picfiles = glob('uploads/thumbs/*'); // get all file names
foreach($picfiles as $picfile){ // iterate files
  if(is_file($picfile))
    unlink($picfile); // delete file
}

$picfiles = glob('uploads/original/*'); // get all file names
foreach($picfiles as $picfile){ // iterate files
  if(is_file($picfile))
    unlink($picfile); // delete file
}
