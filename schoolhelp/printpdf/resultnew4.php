...
//result comment
 //Checking Attendance Table
	...
	if ($resultbackground==1) {
		...
		$divbackground='<img src="'.$logoaddress.'" style="position:fixed; top:140; width:100%; opacity:0.005; -ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=0.005)"; filter: alpha(opacity=0.005); -moz-opacity:0.005; -khtml-opacity: 0.005;  z-index:-2 "/>';
	}
...
$html .=$div.$divbackground.'
   ...
   if ($semesterid==3) { 
    ...
    <th  style="text-align:center; width:auto">Remark</th>
		...
		$html.='<td style="width:25%" valign="top"><table valign="top" style="width:100%;  margin:2px; padding:2px; border-collapse:collapse;" cellspacing="0px" cellpadding="0px">
		<tr>
		...
		$html.='<tr><td style="width:50%; font-size:10px;">'.$domainrec["domainname"].'</td><td style="width:8%;"><center>'; if($domainstate==5) { $html.= '<img style="width:50%" src="../images/check-mark.png" />'; } $html.='</center></td><td style="width:8%"><center>'; if($domainstate==4) { $html.= '<img style="width:50%" src="../images/check-mark.png" />'; } $html.='</center></td><td style="width:8%"><center>'; if($domainstate==3) { $html.= '<img style="width:50%" src="../images/check-mark.png" />'; } $html.='</center></td><td style="width:8%"><center>'; if($domainstate==2) { $html.= '<img style="width:50%" src="../images/check-mark.png" />'; } $html.='</center></td><td style="width:8%"><center>'; if($domainstate==1) { $html.= '<img style="width:50%" src="../images/check-mark.png" />'; } $html.='</center></td></tr>';
		}
	}
		$html.='</table>
		</td>
	...
	if ($principlec=="") {
		...
		<tr>
		<td style="text-align:center; font-family: Arial Black; font-size:10px;" >'.$teachersc.'</td>
		</tr>
		<tr>
		...
		<tr>
		<td style="text-align:center; font-family: Arial Black; font-size:10px;" >'.$principlec.'</td>
		</tr>
		</table>
		</td></tr></table>
