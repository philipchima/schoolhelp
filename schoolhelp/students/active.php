                    ...
                    <table id="datatable-buttons"  style="width:100%" class="table table-striped table-bordered table-responsive">
                      ...
                      <tbody>
                        <?php $k=0; 
                             ...
                             if ($type==1) {
                                //Active Students
                              $records=$schoolhelpDH->allstudentedit3('students', 'status', 0, 'access', 0,  'levelid', $levelid);
                             }
                             elseif ($type==2) {
                              $records=$schoolhelpDH->allstudentedit4('students', 'status', 0, 'access', 0, 'levelid', $levelid, 'optid', $optionid); 
                             }else{
                              //All Students
                                $records=$schoolhelpDH->allstudentedit2('students', 'status', 0, 'access', 0); 
                              }
