                      ...
                      <table   class="table table-striped table-bordered table-responsive">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            $total_male+=$male;
                            ?></a></center></td>
                            <td style="font-size:24px"><center><a href="female?schoolhelp=<?php echo $schoolhelp; ?>type=1&levelid=<?php echo trim($fieldrecord['levelid']) ?>&optionid=<?php echo $optionid; ?>"><?php echo  $male=count($records=$schoolhelpDH->allstudentedit4('students', 'status', 0, 'access', 0, 'sexid', 2, 'levelid', trim($fieldrecord['levelid']))); 
                            $total_female+=$female;
                            ?></a></center></td>
                             <td style="font-size:24px"><center><a href="studenttype?schoolhelp=<?php echo $schoolhelp; ?>type=1&levelid=<?php echo trim($fieldrecord['levelid']) ?>&optionid=<?php echo $optionid; ?>"><?php echo  $boarder=count($records=$schoolhelpDH->allstudentedit4('students', 'status', 0, 'access', 0, 'studenttype', 2, 'levelid', trim($fieldrecord['levelid']))); 
                             $total_boarder+=$boarder;
                            ?></a></center></td>
                            <td style="font-size:24px"><center><a href="studenttype?schoolhelp=<?php echo $schoolhelp; ?>type=1&levelid=<?php echo trim($fieldrecord['levelid']) ?>&optionid=<?php echo $optionid; ?>"><?php echo  $dialy=count($records=$schoolhelpDH->allstudentedit4('students', 'status', 0, 'access', 0, 'studenttype', 1, 'levelid', trim($fieldrecord['levelid']))); 
                             $total_daily+=$daily;
                            ?></a></center></td>
                            <td>
                              <?php
                                 $records1=$schoolhelpDH->allstudent('housedivision', 'hdid', 'ASC');
                                  if (is_array($records1)) { ?>
                                  <ul style="list-style: none">
                                   <?php foreach($records1 as $fieldrecord1){ ?>
                                    <li><a href="studenttype?schoolhelp=<?php echo $schoolhelp; ?>type=1&levelid=<?php echo trim($fieldrecord['levelid']) ?>&optionid=<?php echo $optionid; ?>"><?php echo trim($fieldrecord1['hdname']) ?>: <?php echo  $dialy=count($records=$schoolhelpDH->allstudentedit4('students', 'status', 0, 'access', 0, 'studenttype', 1, 'levelid', trim($fieldrecord['levelid']))); 
                             $total_daily+=$daily;
                            ?></a></li>
                                  <?php  } ?>
                                  </ul>
                            ...
                            <td><?php echo count($records=$schoolhelpDH->allstudentedit3('students', 'status', 0, 'access', 1, 'levelid', trim($fieldrecord['levelid']))); ?></td>
                            <td></td>
                            <td></td>
                                ...
                                if ($departmentid==$logindepartmentid) {?>
                                      ...
                                      <td ><span class="btn-group">
                                          ...
                                          <ul role="menu" class="dropdown-menu" style="list-style-type: none;" >
                                             ...
                                             <li onclick="funcresetpassword('<?php echo $schoolhelp; ?>','<?php echo $fieldrecord['stid']; ?>');"><a href="#">Reset Password</a></li>
