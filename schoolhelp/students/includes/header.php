...
$schoolhelpheader= new classStudent;
$adminid=trim(isset($_GET['schoolhelp'])?$_GET['schoolhelp']:false);
$schoolhelp =trim(isset($_SESSION['schoolhelp'.$adminid])?$_SESSION['schoolhelp'.$adminid]:false);

$previlleges=$schoolhelpheader->allstudentedit('adminpersons', 'adminid', $schoolhelp);
...
$instilogo="";
   ...
   $records1=$schoolhelpheader->allstudentedit('adminpersons', 'adminid', $schoolhelp);
                     ...
                     foreach($records1 as $fieldrecord1){
                               ...
                               if ($admintype1==1) {
                                  ...
                                  //To retrieve any schools logo
                                   $logodata1=$schoolhelpheader->allstudent('institution', 'i_id',  'ASC');
                                  ...
                                  //Getting Staff ID
                                        $signatorydata1=$schoolhelpheader->allstudentedit('signatoryposition', 'signatorypositionid',  $signatorypositionid1);
                                           if(is_array($signatorydata1)){
                                             ...
                                             $logodata1=$schoolhelpheader->allstudentedit('institution', 'departmentid',  $departmentid1);
                                           if(is_array($logodata1)){
                                              foreach($logodata1 as $logorec1){
                                                $photologo=$logorec1['instilogo'];
                                                $instilogo="../images/logo/".$photologo;
                                        ...
                                        //Getting Staff ID
                                        $staffdata1=$schoolhelpheader->allstudentedit('staff', 'staffid',  $staffid1);
                                           if(is_array($staffdata1)){
                                            ...
                                            //getting department Name
                                             $departmentdata1=$schoolhelpheader->allstudentedit('department', 'did',  $departmentid1);
