...
if ($page==10) {
  if ($dashedit_d==1) {
    $stid=trim(isset($_GET['id'])?$_GET['id']:false);
    echo $accessvalue=trim(isset($_GET['accessvalue'])?$_GET['accessvalue']:false);
    $udate=date("Y-m-d H:m:s");
                  ...
                  <div class="x_title" style="background: #61dc42; padding-top: 10px; border-radius: 6px;">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <?php  if ($dashadd_d==1) {?>
                        <li><a href="?schoolhelp=<?php echo $schoolhelp; ?>&page=1"  ><i class="fa fa-plus"></i>  Add Student</a></li>

                        <li><a href="?schoolhelp=<?php echo $schoolhelp; ?>&page=8"  ><i class="fa fa-plus"></i>  Upload Multiple Students</a></li>
                        <?php } ?>
                        <li ><a  href="?schoolhelp=<?php echo $schoolhelp; ?>&page=11"><i class="fa fa-book"></i> View</a></li>
                        <?php  if ($dashadd_d==1) {?>
                      ...
                      <table   class="table table-striped table-bordered table-responsive">
                        <thead>
                          <tr>
                            ...
                            <th>Suspended </th>
                            <th> Active <?php echo $pagename; ?></th>
                            <th>Total <?php echo $pagename; ?></th>
                        ...
                        <tbody>
                          ...
                          $total_active=0;
                            ...
                            if ($admintype==1) {
                              $records=$schoolhelpDH->allstudent('level', 'levelrank', 'ASC');
                            }else{
                              $records=$schoolhelpDH->allstudentedit('level', 'departmentid', $logindepartmentid);
                            }
                          ...
                          <tr>
                            ...
                            <td style="font-size:24px"><center><a href="male?schoolhelp=<?php echo $schoolhelp; ?>&type=1&levelid=<?php echo trim($fieldrecord['levelid']) ?>&optionid=<?php echo $optionid; ?>"><?php echo  $male=count($records=$schoolhelpDH->allstudentedit4('students', 'status', 0, 'access', 0, 'sexid', 1, 'levelid', trim($fieldrecord['levelid']))); 
                            $total_male+=$male;
                            ?></a></center></td>
                            <td style="font-size:24px"><center><a href="female?schoolhelp=<?php echo $schoolhelp; ?>&type=1&levelid=<?php echo trim($fieldrecord['levelid']) ?>&optionid=<?php echo $optionid; ?>"><?php echo  $female=count($records=$schoolhelpDH->allstudentedit4('students', 'status', 0, 'access', 0, 'sexid', 2, 'levelid', trim($fieldrecord['levelid']))); 
                            $total_female+=$female;
                            ?></a></center></td>
                             <td style="font-size:24px"><center><a href="boarder?schoolhelp=<?php echo $schoolhelp; ?>&type=1&levelid=<?php echo trim($fieldrecord['levelid']) ?>&optionid=<?php echo $optionid; ?>"><?php echo  $boarder=count($records=$schoolhelpDH->allstudentedit4('students', 'status', 0, 'access', 0, 'studenttype', 2, 'levelid', trim($fieldrecord['levelid']))); 
                             $total_boarder+=$boarder;
                            ?></a></center></td>
                            <td style="font-size:24px"><center><a href="daily?schoolhelp=<?php echo $schoolhelp; ?>&type=1&levelid=<?php echo trim($fieldrecord['levelid']) ?>&optionid=<?php echo $optionid; ?>"><?php echo  $dialy=count($records=$schoolhelpDH->allstudentedit4('students', 'status', 0, 'access', 0, 'studenttype', 1, 'levelid', trim($fieldrecord['levelid']))); 
                             $total_daily+=$daily;
                            ?></a></center></td>
                           
                            <td style="font-size:24px"><center><a href="suspended?schoolhelp=<?php echo $schoolhelp; ?>&type=1&levelid=<?php echo trim($fieldrecord['levelid']) ?>&optionid=<?php echo $optionid; ?>"><?php echo $suspended=count($records=$schoolhelpDH->allstudentedit3('students', 'status', 0, 'access', 1, 'levelid', trim($fieldrecord['levelid']))); 
                            $total_suspended+=$suspended;
                            ?></a></td>
                            <td style="font-size:24px"><center><a href="active?schoolhelp=<?php echo $schoolhelp; ?>&type=1&levelid=<?php echo trim($fieldrecord['levelid']) ?>&optionid=<?php echo $optionid; ?>"><?php echo $active=count($records=$schoolhelpDH->allstudentedit3('students', 'status', 0, 'access', 0, 'levelid', trim($fieldrecord['levelid']))); 
                            $total_active+=$active;
                            ?></a></td>
                            <td style="font-size:24px"><center><a href="total?schoolhelp=<?php echo $schoolhelp; ?>&type=1&levelid=<?php echo trim($fieldrecord['levelid']) ?>&optionid=<?php echo $optionid; ?>"><?php echo $all=count($records=$schoolhelpDH->allstudentedit2('students', 'status', 0, 'levelid', trim($fieldrecord['levelid']))); 
                            $total_all+=$all;
                            ?></a></td>
                           ...
                           <?php 
                           // Selecting groups
                           $records1=$schoolhelpDH->allstudenteditorder('optiontable', 'levelid', trim($fieldrecord['levelid']), 'optpriority', 'ASC');
                         ...
                         <?php } ?>
                            ...
                            <td></td>
                              <td>Total </td>
                            <td style="font-size:24px"><center><a href="male?schoolhelp=<?php echo $schoolhelp; ?>&type=3"><?php echo  count($records=$schoolhelpDH->allstudentedit3('students', 'status', 0, 'access', 0, 'sexid', 1)); ?></a></center></td>
                            
                            
                            <td style="font-size:24px"><center><a href="female?schoolhelp=<?php echo $schoolhelp; ?>&type=3"><?php echo count($records=$schoolhelpDH->allstudentedit3('students', 'status', 0, 'access', 0, 'sexid', 2)); ?></a></center></td>
                            <td style="font-size:24px"><center><a href="boarder?schoolhelp=<?php echo $schoolhelp; ?>&type=3"><?php echo count($records=$schoolhelpDH->allstudentedit3('students', 'status', 0, 'access', 0, 'studenttype', 2)); ?></a></center></td>
                             <td style="font-size:24px"><center><a href="dialy?schoolhelp=<?php echo $schoolhelp; ?>&type=3"><?php echo  count($records=$schoolhelpDH->allstudentedit3('students', 'status', 0, 'access', 0, 'studenttype', 2)); ?></a></center></td>
                              <td style="font-size:24px"><center><a href="suspended?schoolhelp=<?php echo $schoolhelp; ?>&type=3"><?php echo  count($records=$schoolhelpDH->allstudentedit2('students', 'status', 0, 'access', 1)); ?></a></center></td>

                            <td style="font-size:24px"><center><a href="active?schoolhelp=<?php echo $schoolhelp; ?>&type=3"><?php echo  count($records=$schoolhelpDH->allstudentedit2('students', 'status', 0, 'access', 0)); ?></a></center></td>
                             <td style="font-size:24px"><center><a href="total?schoolhelp=<?php echo $schoolhelp; ?>&type=3"><?php echo  count($records=$schoolhelpDH->allstudentedit('students', 'status', 0)); ?></a></center></td>
                    ...
                    <table id="datatable-buttons"  style="width:100%" class="table table-striped table-bordered table-responsive">
                      ...
                      <tbody>
                        <?php $k=0; 
                             ...
                             if ($studentstaus==1) {
                                //Active Students
                              $records=$schoolhelpDH->allstudentedit('students', 'status', $studentstaus);
                             }else{
                              //All Students
                                $records=$schoolhelpDH->allstudent('students', 'stid', 'DESC');
                              }
                    ...
                    <section class="content invoice">
                      ...
                      <div class="row no-print">
                        <div class="col-xs-12">
                          ...
                          <div class="col-xs-6"><a class="btn btn-danger "  href="?page=3&schoolhelp=<?php echo $schoolhelp; ?>&id=<?php echo $stid; ?>"><i class="fa fa-edit"></i> Edit</a></div>
